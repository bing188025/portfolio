...
function TestimonialCard({ testimonial }) {
  return (
    <div className="relative rounded-xl border border-pink-200 bg-white p-6 md:p-8 transition-all duration-300 hover:shadow-lg hover:border-pink-300 hover:-translate-y-1">
      <div className="flex items-center justify-between mb-5">
        ...
        <FaQuoteRight className="text-pink-200" size={32} />
      </div>
...
function Testimonials() {
  return (
    <div id="testimonials" className="relative z-50 border-t my-12 lg:my-24 border-pink-200">
