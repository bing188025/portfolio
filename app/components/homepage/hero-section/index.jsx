...
const NeuralBackground = dynamic(() => import('./neural-background'), { ssr: false });
        ...
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="flex items-center gap-3">
            <Link href="#contact" className="bg-gradient-to-r to-pink-500 from-rose-600 p-[1px] rounded-full transition-all duration-300 hover:from-pink-500 hover:to-amber-500">
              <button className="px-3 text-xs md:px-8 py-3 md:py-4 bg-[#0f0a1e] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3">
                <span>Contact me</span>
                <RiContactsFill size={16} />
              </button>
            </Link>

            <Link className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-pink-500 to-rose-600 px-3 md:px-8 py-3 md:py-4 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold" role="button" target="_blank" href={personalData.resume}
            >
            ...
            <div className="overflow-hidden border-t-[2px] border-pink-900/50 px-4 lg:px-8 py-4 lg:py-8 code-shimmer">
              <code className="font-mono text-xs md:text-sm lg:text-base">
                ...
                <div>
                  ...
                  <span className="text-gray-400">{`'`}</span>
                  <span className="text-amber-300">Kenzan Umezaki</span>
                  <span className="text-gray-400">{`',`}</span>
                </div>
